...
const es: Dictionary = {
  ...
  matchDetail: {
    ...
    pendingYourVotes: 'Votá a los jugadores restantes para cerrar tu parte de la votación.',
    ...
    colAfter: 'Después',
    colDelta: 'Δ',
    confirmApply: '¿Aplicar ratings ahora? Esto cerrará la votación para todos.',
